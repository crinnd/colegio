...
ADMINS = (
    (os.getenv('ADMIN_NAME', 'Cristian'), os.getenv('ADMIN_EMAIL', 'air.enrill@gmail.com')),
)

MANAGERS = ADMINS

DATABASES = {
    'default': dj_database_url.config(default='sqlite:///' + os.path.join(PROJECT_ROOT, 'dev.db'))
}
...
SECRET_KEY = 'b@tp3l*)$4t*^l0%)^!+0gydvv!*8zjau6o(g96b)0^h)-as5s'
